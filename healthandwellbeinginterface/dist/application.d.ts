...
declare const HealthandwellbeinginterfaceApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class HealthandwellbeinginterfaceApplication extends HealthandwellbeinginterfaceApplication_base {
